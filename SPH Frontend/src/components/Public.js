...
const Public = () => {
  const content = (
    <body className="w-full">
      <header>
        <nav className="bg-red-900  border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            ...
            <div className="flex items-center lg:order-2">
                <a
                  href="/login"
                  className="text-white dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800"
                >
                  Log in
                </a>
            ...
            >
              <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                ...
                <Link to="partners" spy={true} smooth={true}>
                  <a
                    href="#"
                    className="block py-2 pr-4 pl-3 text-white border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-white lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700"
                  >
                    Partners
                  </a>
                </Link>
      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="grid py-8 px-4 mx-auto max-w-screen-xl lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="place-self-center mr-auto lg:col-span-7">
            <h1 className="mb-4 max-w-2xl text-4xl font-extrabold leading-none md:text-5xl xl:text-5xl dark:text-white">
              Office of the Community Extension Services (OCES)
            </h1>
            <p className="mb-6 max-w-2xl font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
            Welcome to the Extension Service arm of the Holy Angel University! We are dedicated to making a positive impact on the world by implementing a wide range of programs and activities that extend beyond the boundaries of our campus.
            </p>
            <a
              href="#"
              className="inline-flex justify-center items-center py-3 px-5 mr-3 text-base font-medium text-center text-gray-500 rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900"
            >
              Get started
              <svg
      ...
      <section className="bg-gray-50 dark:bg-gray-800">
        <div id="partners" className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          ...
          <div className="grid row-span-2 grid-cols-2 gap-4 mt-8">
            ...
            <div>
              <h3 className="mb-2 text-xl font-bold dark:text-white">Public Schools in Angeles City and   Pampanga</h3>
              <li className="text-base text-gray-500 dark:text-gray-400">
                Elementary Schools
              </li>
              <li className="text-base text-gray-500 dark:text-gray-400">
      ...
      <section className="bg-white dark:bg-gray-900">
        <div id="contact" className="py-6 px-4 mx-auto max-w-screen-xl sm:py-10 lg:px-4">
          <div className="mx-auto max-w-screen-sm text-center">
            ...
            <p className="font-light text-gray-500 dark:text-gray-400 md:text-lg">
              Thank you for your interest in our Extension Service arm of the University! We are here to answer any questions you may have about our programs and activities.
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="p-4 bg-gray-50 sm:p-6 dark:bg-gray-800">
        <div className="mx-auto max-w-screen-xl">
          <div className="md:flex md:justify-between">
            <div className="grid grid-cols-5 gap-8 sm:gap-6 sm:grid-cols-3">
            <div className="row-span-3">
              ...
              <img
                ...
                alt="ICFSI Logo"
              />
              <span className="self-center text-red-900 text-xl font-semibold whitespace-nowrap">
                SAUP Portal HAU
              </span>
              </div>
            </div>
              ...
              <div>
                <h2 className="mb-2 text-sm font-semibold text-gray-900 uppercase dark:text-white">
                  Coordinator, National Service Training Program (NSTP) / Staff, Campus Ministry Office
                </h2>
                <div className="mb-2 text-base font-semibold">
                    Ms. Hazel A. Basilio
                  </div>
