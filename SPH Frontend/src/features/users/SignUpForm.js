...
const SignUpForm = () => {
  useTitle("SAUP Portal: Sign Up");

  const [addNewSignupUser, { isLoading, isSuccess, isError, error }] =
    useAddNewSignupUserMutation();
  ...
  useEffect(() => {
    setValidEmail(email.includes("hau.edu.ph"));
  }, [email]);
    ...
    <section>
      <main>
        ...
        >
          ...
          <div className="">
            <label className="text-base" htmlFor="user_id">
              User ID:
            </label>
            <br></br>
            <input
          ...
          <div>
            ...
            />
            {validEmail ? (
              <p className="text-gray-500 italic text-sm">Valid email</p>
            ) : (
              <p className="text-red-700 italic text-sm">
                Email address must end in hau.edu.ph
              </p>
            )}
          </div>
          <div>
          ...
          <div>
            <div className="w-full grid">
              <label className="text-base align-middle" htmlFor="roles">
                Assigned Role:
              </label>
              <select
                id="roles"
